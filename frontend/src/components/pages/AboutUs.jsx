  ...
  return (
    <Container maxWidth="md" sx={{ py: 6 }}>
      ...
      >
        ...
        <Typography variant="h5" gutterBottom>
          Про нас (Українська версія)
        </Typography>
        <Typography variant="body1" paragraph>
          Ласкаво просимо до <strong>Mercury Blog</strong> — сучасної платформи,
          створеної для людей, які люблять ділитися своїми ідеями, історіями та
          досвідом із усім світом. Наша місія — дати кожному можливість
          висловитися й зробити блогінг простим, приємним і натхненним.
        </Typography>

        <Typography variant="body1" paragraph>
          У Mercury ми віримо, що кожен має щось цінне, чим може поділитися.
          Незалежно від того, чи ти письменник, мандрівник, фотограф або просто
          людина, яка хоче висловити свої думки — наша платформа допоможе
          зробити це красиво та зручно.
        </Typography>

        <Typography variant="body1" paragraph>
          Ми прагнемо створити чистий і зручний простір, де креативність
          поєднується з технологіями. Завдяки нашому інтуїтивному редактору,
          категоріям і профілям користувачів ти можеш легко створювати цікаві
          пости та спілкуватися з людьми, які мають схожі інтереси.
        </Typography>
